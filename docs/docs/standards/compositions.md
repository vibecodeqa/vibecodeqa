...
|---|---|---|---|
| [React SPA](stacks/react-spa.md) | authored | [v1](/standards/react-spa/v1/) | `react`, `react-router`, `vite`, `typescript`, `web-accessibility`, `web-security`, `vitest`, `playwright` |
...
| [Node CLI Internal Tool](stacks/node-cli-internal-tool.md) | planned | planned | `typescript`, `node`, `openapi`, `web-security` |
| [TypeScript SDK](stacks/typescript-sdk.md) | planned | planned | `typescript`, `openapi`, `zod`, `vitest` |
| [GitHub Action Package](stacks/github-action-package.md) | planned | planned | `github-action`, `github-actions`, `node`, `typescript` |
