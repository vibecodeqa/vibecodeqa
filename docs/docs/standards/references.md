...
| [MCP Security Best Practices](https://modelcontextprotocol.io/docs/tutorials/security/security_best_practices) | Model Context Protocol | Tracks current canonical upstream URL. | CI-enforced 2xx | none expected | `mcp-server` | `mcp-client`, `ai-tools` | Tool poisoning defenses; authorization risks; prompt injection considerations |
