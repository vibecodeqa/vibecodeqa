...
| [vibecodeqa/ref-cloudflare-pages-fullstack](https://github.com/vibecodeqa/ref-cloudflare-pages-fullstack) | `cloudflare-pages-fullstack`, `react-spa`, `typescript`, `testing`, `security` | React SPA plus same-origin Cloudflare Pages Functions API, route ownership, bindings, and deploy evidence. | [92/100 report](https://github.com/vibecodeqa/ref-cloudflare-pages-fullstack/blob/main/docs/vcqa-report.md); CI green |
| [vibecodeqa/ref-cloudflare-d1-app](https://github.com/vibecodeqa/ref-cloudflare-d1-app) | `cloudflare-d1-app`, `typescript`, `testing`, `security` | D1 migrations, local apply checks, bindings, query safety, and environment isolation without the broader SaaS composition. | [92/100 report](https://github.com/vibecodeqa/ref-cloudflare-d1-app/blob/main/docs/vcqa-report.md); CI green |
