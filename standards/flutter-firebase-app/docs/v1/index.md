...
- Catalog page: [/docs/standards/stacks/flutter-firebase-app/](/docs/standards/stacks/flutter-firebase-app/)
- Latest edition: `v1`
- Edition lifecycle: active. Errata: none.
- Composes: [dart](/docs/standards/items/dart/), [flutter](/docs/standards/items/flutter/), [firebase](/docs/standards/items/firebase/), [melos](/docs/standards/items/melos/), [github-actions](/docs/standards/items/github-actions/), [dependencies](/docs/standards/items/dependencies/), [web-accessibility](/docs/standards/items/web-accessibility/) (optional), [web-security](/docs/standards/items/web-security/) (optional), [node](/docs/standards/items/node/) (optional)
- Reference implementations: [ref-flutter-firebase-app](https://github.com/vibecodeqa/ref-flutter-firebase-app)
- Related standards: [cloudflare-pages-fullstack](/standards/cloudflare-pages-fullstack/v1/), [cloudflare-d1-app](/standards/cloudflare-d1-app/v1/), [cloudflare-worker-mcp-server](/standards/cloudflare-worker-mcp-server/v1/), [tenant-deployed-cloudflare-saas](/standards/tenant-deployed-cloudflare-saas/v1/), [security](/standards/security/v1/), [testing](/standards/testing/v1/), [typescript](/standards/typescript/v1/), [github-action-package](/docs/standards/stacks/github-action-package/)
