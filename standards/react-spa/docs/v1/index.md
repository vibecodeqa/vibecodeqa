...
- Catalog page: [/docs/standards/stacks/react-spa/](/docs/standards/stacks/react-spa/)
- Latest edition: `v1`
- Edition lifecycle: active. Errata: none.
- Composes: [react](/docs/standards/items/react/), [react-router](/docs/standards/items/react-router/), [vite](/docs/standards/items/vite/), [typescript](/docs/standards/items/typescript/), [web-accessibility](/docs/standards/items/web-accessibility/), [web-security](/docs/standards/items/web-security/), [vitest](/docs/standards/items/vitest/), [playwright](/docs/standards/items/playwright/)
- Reference implementations: [ref-react-spa](https://github.com/vibecodeqa/ref-react-spa), [ref-cloudflare-saas](https://github.com/vibecodeqa/ref-cloudflare-saas), [ref-cloudflare-pages-fullstack](https://github.com/vibecodeqa/ref-cloudflare-pages-fullstack), [ref-firebase-react-fullstack](https://github.com/vibecodeqa/ref-firebase-react-fullstack), [ref-tauri-react-desktop](https://github.com/vibecodeqa/ref-tauri-react-desktop)
- Related standards: [tauri-react-desktop](/docs/standards/stacks/tauri-react-desktop/), [cloudflare-pages-fullstack](/standards/cloudflare-pages-fullstack/v1/), [cloudflare-d1-app](/standards/cloudflare-d1-app/v1/), [cloudflare-worker-mcp-server](/standards/cloudflare-worker-mcp-server/v1/), [typescript](/standards/typescript/v1/), [node-cli-internal-tool](/docs/standards/stacks/node-cli-internal-tool/), [typescript-sdk](/docs/standards/stacks/typescript-sdk/), [github-action-package](/docs/standards/stacks/github-action-package/)
